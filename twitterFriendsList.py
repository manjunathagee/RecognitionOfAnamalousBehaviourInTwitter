...
def get_all_tweets(screen_name):
    ...
    outtweets = [[tweet.user.id,tweet.id_str.encode("utf-8"), tweet.created_at, tweet.text.encode("utf-8"),tweet.retweet_count,tweet.favorite_count,
...
with open('tweets.csv', 'a') as f:
	writer = csv.writer(f)
	writer.writerow(["user_id","id","created_at","text","retweet_count","favorite_count","isRetweeted","source","followers_count","friends_count","name","user_created_at","screen_name","tweet_language"])
pass
